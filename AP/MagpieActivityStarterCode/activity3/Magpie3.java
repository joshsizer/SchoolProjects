...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		if (statement.length() < 1) {
		...
		} else if (findKeyword(statement, "Mr. Steinberg") >= 0) {
			response = "He sounds like a good teacher.";
				...
				|| statement.indexOf("black") >= 0) {
			response = "Color's are cool.";
		} else if(findKeyword(statement, "game") >= 0) {
			response = "What's your favorite game?";
	...
	private String getRandomResponse()
	{
		...
		if (whichResponse == 0) {
			...
			response = "Okay, tell me more.";
		} else if (whichResponse == 5) {
			response = "Wow, you just told me something.";
		}
